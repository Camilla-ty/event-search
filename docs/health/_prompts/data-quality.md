...
7. When (and only when) publication or remediation closeout is explicitly
   ...
   - the cycle report: docs/health/data-quality/{{CYCLE}}-data-quality.md
...
Write docs/health/data-quality/{{CYCLE}}-data-quality.md from
...
prior-cycle reports not rewritten for terminology; no application code or data mutated; unrelated files
