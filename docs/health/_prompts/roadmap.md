...
6. When (and only when) publication or remediation closeout is explicitly
   ...
   - the cycle report: docs/health/roadmap/{{CYCLE}}-roadmap.md
...
Write docs/health/roadmap/{{CYCLE}}-roadmap.md from
...
prior-cycle reports not rewritten for terminology; roadmap source docs untouched; unrelated files
