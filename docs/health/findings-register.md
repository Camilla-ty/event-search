...
|----|-------|------|----------|--------|--------|-----------|--------------|----------------|
| ARC-002 | Hot-path full-table scans for sponsor counts (`getSponsorCountsByEditionIds`) | performance / db | Critical | Small | Open | 2026-07 | 2026-08 | [Architecture 2026-07 §ARC-002](./architecture/2026-07-architecture.md) |
...
| ARC-005 | No CI gate (typecheck / lint / test / build) on PRs | ci / tooling | High | Small | Open | 2026-07 | 2026-08 | [Architecture 2026-07 §ARC-005](./architecture/2026-07-architecture.md) |
...
| DB-001 | exhibitor_import_publish_batch executable by anon/authenticated after grant hotfix | database / rpc-grants | High | Small | Open | 2026-07 | 2026-07 | [Database 2026-07 §DB-001](./database/2026-07-database.md) |
