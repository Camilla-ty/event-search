...
| 3 | Create series form | Enter name; slug auto-updates; optional description, website, logo URL |
...
| Website URL | `event_series.website_url` | No | Yes | |
| Logo URL | `event_series.logo_url` | No | Yes | URL string v1 |
