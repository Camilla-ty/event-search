...
| **Logos** | columns on `companies` | `logo_url` + Logo.dev metadata (`logo_source`, `logo_status`, etc.). |
...
- **Verification:** `npm run build` plus manual API/UI checks; no automated test suite.
