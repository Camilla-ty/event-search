  ...
  return (
    <section>
      ...
      <AdminPageHeader
        ...
        description="Create an occurrence of an event series (e.g. TOKEN2049 Singapore 2026). Multiple event editions per event series and year are allowed — use city and a distinct slug to disambiguate."
      />
      <EventsSubNav />
      <EventEditionForm
        mode="create"
