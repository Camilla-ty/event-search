...
import { acknowledgeReview } from "@/src/features/partner-alumni-import/server/materializePipeline";
...
export async function POST(_request: Request, context: RouteContext) {
  ...
  try {
    const batch = await acknowledgeReview(params.batchId, scope, auth.context.userId);
