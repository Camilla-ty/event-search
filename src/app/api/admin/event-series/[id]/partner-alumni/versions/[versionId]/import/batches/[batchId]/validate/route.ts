...
import { runBatchValidation } from "@/src/features/partner-alumni-import/server/partnerAlumniImportAdmin";
...
export async function POST(_request: Request, context: RouteContext) {
  ...
  try {
    const result = await runBatchValidation(params.batchId, scope, auth.context.userId);
