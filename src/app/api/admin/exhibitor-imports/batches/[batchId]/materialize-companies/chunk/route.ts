...
import { runMaterializeCompaniesChunk } from "@/src/features/exhibitor-import/server/exhibitorImportAdmin";
...
export async function POST(request: Request, context: RouteContext) {
  ...
  try {
    const result = await runMaterializeCompaniesChunk(batchId, auth.context.userId, body);
