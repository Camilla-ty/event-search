    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-sky-200 bg-sky-50 px-5 py-4">
        ...
        <p className="mt-2 text-sm text-sky-900">
          Sponsor import for this event edition will be available in Phase 4. When live, you will
          upload an Excel file, review matches, publish sponsors to this event edition, and see
          import history here.
        </p>
