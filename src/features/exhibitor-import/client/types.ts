import type {
  ...
  ExhibitorImportProcessingPhase,
...
export type ExhibitorImportBatch = {
  id: string;
  event_edition_id: string;
  status: ExhibitorImportBatchStatus;
  processing_phase: ExhibitorImportProcessingPhase | null;
...
export type BatchListItem = ExhibitorImportBatch & {
  edition_name?: string;
  edition_year?: number;
