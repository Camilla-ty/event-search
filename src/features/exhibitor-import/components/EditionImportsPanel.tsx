  ...
  return (
    <div className="space-y-6">
      <div className="rounded-lg border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700">
        ...
        <p className="mt-1 text-slate-600">Live exhibitors: {panelData.liveExhibitorCount}</p>
      </div>
        ...
        {activeId && activeStatus ? (
          <div className="space-y-3">
            ...
            <p className="text-sm text-slate-600">
              One active import per event edition. Resume or discard before starting a new import.
            </p>
          ...
          <div className="space-y-3">
            ...
            <Link
              href={`/admin/exhibitor-imports/new?editionId=${panelData.editionId}`}
              className={`${primaryCtaClass} h-10`}
            >
              Bulk Upload
            </Link>
