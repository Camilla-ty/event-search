...
export function DraftReviewStep() {
  ...
  useEffect(() => {
    ...
    // Intentionally keyed to batch.id — reload closes over latest batch handlers.
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">
          Review draft exhibitor links before publishing. Publishing is additive — existing live
          exhibitors stay unchanged.
        </p>
      </div>
