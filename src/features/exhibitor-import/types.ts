export const EXHIBITOR_IMPORT_MAX_ROWS = 500;

export const EXHIBITOR_IMPORT_BUCKET = "exhibitor-imports";

export type ExhibitorImportBatchStatus =
  | "uploaded"
  | "review"
  | "draft"
  | "published"
...
export type ExhibitorImportProcessingPhase =
  | "parsing"
  | "validating"
  | "matching"
...
export type ExhibitorImportRowStatus =
  | "needs_review"
  | "auto_ready"
  | "resolved"
  | "excluded";

export type ExhibitorImportDecisionType =
  | "use_matched"
  | "create_new"
  | "choose_different"
  | "exclude";

export type ExhibitorImportActionType =
  | "upload"
