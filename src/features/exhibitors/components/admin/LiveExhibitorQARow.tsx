...
import { LiveSponsorLogoPreview } from "@/src/features/events/components/admin/LiveSponsorLogoPreview";
...
export function LiveExhibitorQARow({
  row,
  positionInTier,
  isFirstInTier,
  isLastInTier,
  ...
  const reorderBlockedTitle = reorderDisabled
    ? "Wait for order save to finish before reordering"
    : isOnlyInTier
      ? "Add another exhibitor to this tier to reorder"
