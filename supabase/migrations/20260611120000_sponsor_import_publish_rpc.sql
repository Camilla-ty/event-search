-- Phase 3: atomic publish for sponsor import batches (single transaction).
...
BEGIN
  ...
  LOOP
    ...
    IF v_live_id IS NULL THEN
      INSERT INTO public.event_sponsors (event_editions_id, company_id, tier_rank)
      VALUES (v_link.event_edition_id, v_link.company_id, v_link.tier_rank);
